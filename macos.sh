...
sudo scutil --set ComputerName "voohost"
sudo scutil --set HostName "voohost"
sudo scutil --set LocalHostName "voohost"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "voohost"
